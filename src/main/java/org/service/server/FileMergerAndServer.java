...
public class FileMergerAndServer {
    ...
    private static final String METADATA_FILE = "/Users/moon/IdeaProjects/hadoopProject/output/metadata.txt"; // 메타데이터 파일 경로
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Path directory = Paths.get("/Users/moon/IdeaProjects/hadoopProject/input/");
...
//        startMetadataServer();
    ...
    public static void mergeFiles(List<Path> files, String metadataFile) throws IOException {
        ...
        blockWriter = new BufferedOutputStream(new FileOutputStream("/Users/moon/IdeaProjects/hadoopProject/output/0.block"));
        try (
            ...
            for (Path file : files) {
                ...
                if (fileSize + (currentBlockSize-1)%BLOCK_SIZE > BLOCK_SIZE) {
                    ...
                    // 블럭파일 새로 열기
                    blockWriter.close();
                    blockWriter = new BufferedOutputStream(new FileOutputStream("/Users/moon/IdeaProjects/hadoopProject/output/"+currentNumber+".block"));
                }
